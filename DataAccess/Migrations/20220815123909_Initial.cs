        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdvertCategoryCategoryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Adverts", x => x.AdvertId);
                    table.ForeignKey(
                        name: "FK_Adverts_AdvertCategories_AdvertCategoryCategoryId",
                        column: x => x.AdvertCategoryCategoryId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Interns_WorkplaceInterns_WorkplaceInternId",
                        column: x => x.WorkplaceInternId,
                        principalTable: "WorkplaceInterns",
                        principalColumn: "WorkplaceInternId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Adverts",
                column: "AdvertCategoryCategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interns_WorkplaceInternId",
                table: "Interns",
                column: "WorkplaceInternId");
